let backUpImg = [
  "https://images.unsplash.com/photo-1514521068412-14c7cd29cc23?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
  "",
];

fetch(
  "https://apis.scrimba.com/unsplash/photos/random?orientation=landscape&query=forest"
)
  .then((res) => res.json())
  .then((data) => {
